...
* [Kage](https://github.com/karim852/Kage-DFIR-toolkit) - Windows DFIR triage console: an 11-step chain covering YARA scanning, log/Sigma correlation, and host artifact analysis.
* [LOKI](https://github.com/Neo23x0/Loki) - Free IR scanner for scanning endpoint with yara rules and other indicators(IOCs).
